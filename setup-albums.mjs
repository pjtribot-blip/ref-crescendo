...
mkdirSync('app/albums', { recursive: true })

writeFileSync('app/albums/page.js', `import Link from 'next/link'
...
export default async function AlbumsPage({ searchParams }) {
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-10">
      ...
      <p className="text-stone-500 mb-8">{count || 0} critiques · Référence Crescendo Magazine</p>
